...
%o`, message, error2, detail);
  ...
  var messages_controller_default = class extends Controller {
    connect() {
  ...
  __publicField(messages_controller_default, "targets", ["container", "input_form"]);

  // app/javascript/controllers/index.js
  application.register("hello", hello_controller_default);
  application.register("messages", messages_controller_default);
